# reference: https://wml-api-pyclient-dev-v4.mybluemix.net/
...
def upload_code_2_deployment_space(wml_client, prj_info):

    # step 1: set space id
    # wml_client.set.default_space(space_id)

    # step 2: compress the file
    compress_code(prj_info['code_dir'])
...
def deploy(wml_client, my_deployable_function, deployment_info):
    ...
    deploy_name = deployment_info['function_name']+'_deployment'
